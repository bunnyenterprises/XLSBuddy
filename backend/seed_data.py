...
EXCEL_FUNCTIONS = [
    ...
    },
    {
        ...
        "simple_explanation": "SUMPRODUCT multiplies items together then adds them up. Like: 3 apples × Rs.10 + 5 oranges × Rs.8 = 70 — done in one formula!",
    },
    {
    ...
    {
        "name": "RANDBETWEEN", "category": "Math",
    ...
    },
    {
        ...
        "example": "=REPLACE(\"Hello World\", 7, 5, \"Excel\") → Hello Excel",
    ...
    },
    {
        ...
        "example": "=TEXTBEFORE(\"John Smith\", \" \") → John",
    ...
    },
    {
        ...
        "example": "=TEXTAFTER(\"John Smith\", \" \") → Smith",
    ...
    },
    {
        ...
        "example": "=TRANSPOSE(A1:C1) converts a row to a column",
    ...
    # ============= DATE EXTENDED =============
    {
        ...
        "example": "=EDATE(TODAY(), 3) → date 3 months from today",
    ...
    },
    {
        ...
        "difficulty": "Beginner",
        "simple_explanation": "HOUR extracts just the hour part from a time. =HOUR(NOW()) might give 14 (for 2 PM). Perfect for analyzing sales by hour of day!",
    },
    {
    ...
    },
    {
        ...
        "example": "=AVERAGEIFS(D2:D10, B2:B10, \"East\", C2:C10, \">100\")",
    ...
    {
        "name": "LARGE", "category": "Statistical",
        "syntax": "=LARGE(array, k)",
        "description": "Returns the k-th largest value in a data set.",
        "example": "=LARGE(A1:A100, 3) → 3rd highest value",
    ...
    {
        "name": "SMALL", "category": "Statistical",
        "syntax": "=SMALL(array, k)",
        "description": "Returns the k-th smallest value in a data set.",
        "example": "=SMALL(A1:A100, 2) → 2nd smallest value",
    ...
    {
        "name": "ISODD", "category": "Information",
        "syntax": "=ISODD(number)",
    ...
    {
        "name": "ISEVEN", "category": "Information",
    ...
    # ============= FINANCIAL EXTENDED =============
    {
        ...
        "example": "=RATE(60, -500, 20000) * 12 → annual interest rate",
    ...
    },
    {
        ...
        "example": "=NPER(0.05/12, -500, 20000) → months to pay off",
